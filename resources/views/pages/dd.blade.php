              ...
              <div class="row">
                  <div class="col-md-6">
                      ...
                      <div class="input-group">
                        ...
                        <input type="date" class="form-control" placeholder="Birthday" name="co_birthday" value="{{old('co_birthday')}}">                    
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="user_assign" class="form-control select2" style="width: 100%;">
                          <option selected="selected" value="{{Auth::id()==1 ? '' : Auth::id()}}">{{Auth::id()==1 ? 'Chọn' : Auth::user()->name}}</option>
                          @foreach ($user as $u)
                  ...
                  <div class="col-md-6">  
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control select2" style="width: 100%;" name="co_localtion" value="{{old('co_localtion')}}" id="city">
                            <option selected="selected" value="">Chọn</option>
                            @foreach ($city as $c)
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="county" style="width: 100%;" value="{{old('county')}}">
                          <option selected="selected" value="">Chọn</option>
                        </select>
                      </div>
