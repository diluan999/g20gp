@extends('layout')
@section('title','Thay Đổi Thông Tin Thành Tích | Quản Lý Cây Gia Phả')
@section('content')
<div class="panel-body">
                ...
                @endif
<form action="{{route('thay-doi-thanh-tich',$edittt->id)}}" method="POST" role="form" enctype="multipart/form-data">
  {{@csrf_field()}}
...
<label>Thành Viên Cũ </label>
        ...
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-user"></i></span>
          <input type="text" class="form-control" placeholder="Họ Và Tên" name="ten" value="{{$edittt->ten}}" disabled>
        </div>

        <label>Loại Thành Tích</label>
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-barcode"></i></span>
          <input type="text" class="form-control" placeholder="Loại Thành Tich" name="loaithanhtich" value="{{$edittt->loaithanhtich}}" >
        </div>

        <label>Ngày Phát Sinh</label>
        <div class="input-group">
          <span class="input-group-addon"><i class="fa fa-birthday-cake"></i></span>
          <input type="date" class="form-control" placeholder="Date" name="ngayphatsinh" value="{{$edittt->ngayphatsinh}}" disabled>
        </div>
